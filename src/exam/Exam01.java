...
public class Exam01 {
    public static void main(String[] args) {
        ...
        // склоняем секунды
        if ((sec % 10 >= 5 && sec % 10 <= 9) ||  sec % 10 == 0 || sec >= 11 && sec <= 20) getSeconds = "секунд";
        else if (sec % 10 >= 2 && sec % 10 <= 4) getSeconds = "секунды";
        else if (sec % 10 == 1) getSeconds = "секунда";

        // склоняем минуты
        if ((min % 10 >= 5 && min % 10 <= 9) ||  min % 10 == 0 || min >= 11 && min <= 20) getMinutes = "минут";
        else if (min % 10 >= 2 && min % 10 <= 4) getMinutes = "минуты";
        else if (min % 10 == 1) getMinutes = "минута";

        // склоняем часы
        if ((hour % 10 >= 5 && hour % 10 <= 9) ||  hour % 10 == 0 || hour >= 11 && hour <= 20) getHours = "часов";
        ...
        // склоняем недели
        if ((week % 10 >= 5 && week % 10 <= 9) ||  week % 10 == 0 || week % 100 >= 11 && week % 100 <= 20) getWeeks = "недель";
